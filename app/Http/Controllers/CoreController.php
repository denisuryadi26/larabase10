...
class CoreController extends Controller
{
    ...
    protected function get_menu()
    {
        ...
        //        });
        //
        //        $parentMenu = Menu::withTrashed()->whereNull('parent_id')->with('childs')->orderBy('menu_order', 'ASC')->get();
        //
        //        $m_url = url()->current();
        //        $url = explode('/', $m_url);
        ...
        //
        //
        //        return ['parentMenu'=>$parentMenu, 'breadcrumbs'=>$breadrumbs];
        ...
        $breadrumbs = get_breadcrumbs($m_url);
        // $breadrumbs = $this->get_breadcrumbs($m_url);
